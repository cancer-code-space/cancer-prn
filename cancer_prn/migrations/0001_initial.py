# Generated by Django 2.1.5 on 2019-04-26 09:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cause', models.ManyToManyField(to='edc_death_report.Cause', verbose_name='What is the primary source of cause of death information? (if multiple source of information, list one with the smallest number closest to the top of the list) ')),
                ('cause_category', models.ManyToManyField(to='edc_death_report.CauseCategory', verbose_name='Based on the above description, what category best defines the major cause of death? ')),
                ('diagnosis_code', models.ManyToManyField(help_text='Use diagnosis code from Diagnosis Reference Listing', max_length=25, to='edc_death_report.DiagnosisCode', verbose_name='Please code the cause of death as one of the following:')),
                ('medical_responsibility', models.ManyToManyField(to='edc_death_report.MedicalResponsibility', verbose_name='Who was responsible for primary medical care of the participant during the month prior to death?')),
                ('reason_hospitalized', models.ManyToManyField(blank=True, null=True, to='edc_death_report.ReasonHospitalized', verbose_name='if yes, hospitalized, what was the primary reason for hospitalisation? ')),
